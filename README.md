...
```javascript
import atan2 from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-atan2@v0.3.1-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/math-base-special-atan2/actions/workflows/test.yml/badge.svg?branch=v0.3.1
[test-url]: https://github.com/stdlib-js/math-base-special-atan2/actions/workflows/test.yml?query=branch:v0.3.1
